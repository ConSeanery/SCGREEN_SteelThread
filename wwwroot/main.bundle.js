...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.PostData = function (post) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__post_data_service__ = __webpack_require__("./src/app/post-data.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["E" /* NgModule */])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_5__post_data_service__["a" /* PostDataService */]],
...
var PostDataService = /** @class */ (function () {
    ...
    PostDataService.prototype.getFoods = function () {
        return this.http.get('/app/food.json').map(function (res) { return res.json(); });
    };
    // Uses Observable.forkJoin() to run multiple concurrent http.get() requests.
    // The entire operation will result in an error state if any single request fails.
    PostDataService.prototype.createFood = function (food) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]({ 'Content-Type': 'application/json' });
        var options = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["d" /* RequestOptions */]({ headers: headers });
        var body = JSON.stringify(food);
        return this.http.post('/api/values/', body, options).map(function (res) { return res.json(); });
    };
