...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__post_data_service__ = __webpack_require__("./src/app/post-data.service.ts");
...
var AppComponent = /** @class */ (function () {
    function AppComponent(http, postDataService) {
        this.http = http;
    ...
    AppComponent.prototype.add = function (name) {
        ...
        this.postDataService.addUser({ name: name })
            .subscribe(function (username) {
            _this.username.push(username);
        });
    };
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Http */], __WEBPACK_IMPORTED_MODULE_2__post_data_service__["a" /* PostDataService */]])
    ], AppComponent);
    return AppComponent;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__post_data_service__ = __webpack_require__("./src/app/post-data.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["E" /* NgModule */])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_6__post_data_service__["a" /* PostDataService */]],
...
var PostDataService = /** @class */ (function () {
    function PostDataService(http) {
        this.http = http;
        this.usernamesUrl = 'api/values'; // URL to web api
    }
    /*
    ...
    */
    ...
    PostDataService.prototype.addUser = function (username) {
        var _this = this;
        return this.http.post('/api/values/', username, httpOptions).pipe(Object(__WEBPACK_IMPORTED_MODULE_3_rxjs_operators__["b" /* tap */])(function (username) { return _this.log("added hero w/ id=" + username.id); }), Object(__WEBPACK_IMPORTED_MODULE_3_rxjs_operators__["a" /* catchError */])(this.handleError('addHero')));
    };
    PostDataService.prototype.handleError = function (operation, result) {
        var _this = this;
    ...
    PostDataService.prototype.log = function (message) {
    };
